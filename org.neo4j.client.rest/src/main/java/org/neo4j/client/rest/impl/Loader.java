...
public class Loader {
	...
	public NodeData loadNodeData(long nodeId) throws RestClientException {
		checkData();
	...
	public RelationshipData loadRelationshipData(long id) throws RestClientException {
		checkData();
	...
	// public Future<RestNodeImpl> deleteNode(final RestNodeImpl node) {
	...
	public RelationshipData createRelationship(RestNodeImpl start, RestNodeImpl end, RelationshipType type)
			throws RestClientException {
		HttpPost request = new HttpPost(start.getNodeData().getCreate_relationship());
		request.setHeader("Accept", "application/json");
		request.setHeader("Content-Type", "application/json");
		NewRelationshipData data = new NewRelationshipData(end.getSelf(), type.name());
		try {
