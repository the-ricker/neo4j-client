...
public interface PropertyContainer {
	 ...
	 *             if there's no property associated with <code>key</code>
	 */
	 ...
	 *            the property key
	 * @param defaultValue
	 *            the default value that will be returned if no property value
	 ...
	 *             if <code>value</code> is of an unsupported type (including
	 *             <code>null</code>)
	 */
